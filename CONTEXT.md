...
- **Active phase:** Phase 1 - Concept Lessons (3 of 10 complete)
- **Last session:** 2026-07-12 - P1-L3 complete (simple vs log returns, adjusted vs raw prices, total return vs price return)
- **Next session goal:** P1-L4 - Signal construction (raw vs normalized factors, z-scoring, winsorization, sector neutralization intuition)
- **Target start of Lesson 4:** Next available session
...
### Status
- Phase: Phase 1 (Concept Lessons) — 3 of 10 lessons complete
- Started: 2026-05-25
