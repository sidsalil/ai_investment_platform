...
- **Active phase:** Phase 1 - Concept Lessons (Finance track: 8 of 10 complete; AI/Agentic, Backtesting Rigor, and Evals tracks not started)
- **Last session:** 2026-07-13 - P1-L8 complete (look-ahead bias deep dive, survivorship bias quantification and construction mechanics, selection bias, data snooping, dollar-neutral vs. beta-neutral construction)
- **Next session goal:** P1-L9 - Transaction costs and real-world frictions (bid-ask spread, market impact, commissions, backtest-vs-live gap). Recommend interleaving P1-LA1 (AI/Agentic track) alongside it — the AI/Agentic track remains at 0/14 while the Finance track is now at 8/10, so the gap between tracks is widening and should be addressed soon.
- **Target start of Lesson 9:** Next available session
...
- [date]: Complete remaining P1 Finance-track lessons (L9-L10).
...
### Status
- Phase: Phase 1 (Concept Lessons) — Finance track 8/10 complete; AI/Agentic, Backtesting Rigor, and Evals tracks not started
- Started: 2026-05-25
...
**P1-L9, P1-L10:** Not yet started. See curriculum.md for lesson-by-lesson scope (transaction costs and frictions, risk/performance metrics).
